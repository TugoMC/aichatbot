        ...
        <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col">
            ...
            <main className="flex-1 flex flex-col justify-center items-center px-4 text-center max-w-3xl mx-auto">
                    ...
                    {serviceCards
                        ...
                        .map((card, index) => (
                            <div key={index} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 text-left hover:border-purple-800 dark:hover:border-purple-500 transition duration-300">
                                ...
                                <button className="flex justify-center items-center w-8 h-8 bg-white dark:bg-gray-700 rounded-full border border-gray-200 dark:border-gray-600 hover:border-green-600 dark:hover:border-green-500 hover:text-green-600 dark:hover:text-green-500 transition duration-300">
                ...
                <div className="w-full max-w-3xl relative mb-8">
                    <div className="bg-white dark:bg-gray-800 rounded-lg flex items-center px-4 py-3 border border-gray-200 dark:border-gray-700">
